...
import kotlinx.android.synthetic.glide.activity_main.*
import kotlinx.android.synthetic.glide.include_content.view.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initToolbar() {
        ...
        collapsing_toolbar.title = resources.getString(R.string.glide_app_name)
